...
const Settings = () => {
    ...
    return (
        <div className='p-6'>
            ...
            <div className='p-6 rounded-md bg-white flex flex-col gap-6 text-primary text-sm font-medium mt-6'>
                <h4 className={'text-base'}>Профиль</h4>
                <div>
                    <p className={'text-center md:text-left'}>Фото профиля</p>
            ...
            <div className='p-6 rounded-md bg-white flex flex-col gap-6 text-primary text-sm font-medium mt-3'>
                <h4 className='font-semibold text-base'>Изменение пароля</h4>
                <div>
