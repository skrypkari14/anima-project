...
const Utility = () => {
    ...
    return (
        <div className='p-6'>
            <h1 className={'text-2xl font-semibold text-[#222225]'}>Utility</h1>
            <div className={'mt-6'}>
            ...
            <div className={'pt-3 flex flex-col gap-3'}>
                <div className={'bg-white rounded-md  flex justify-between items-center p-6'}>
                    <h4 className={'text-base font-medium text-[#222225]'}>Sprint</h4>
                ...
                <div className={'bg-white rounded-md  flex justify-between items-center p-6'}>
                    <h4 className={'text-base font-medium text-[#222225]'}>FreeCam</h4>
                    <label className="switch">
                        <input type="checkbox"/>
                        <span className="slider"></span>
                        <span className="knob"></span>
                ...
                <div className={'bg-white rounded-md  flex justify-between items-center p-6'}>
                    <h4 className={'text-base font-medium text-[#222225]'}>MidClick Pearl</h4>
                    <label className="switch">
                        <input type="checkbox"/>
                        <span className="slider"></span>
                        <span className="knob"></span>
                ...
                <div className={'bg-white rounded-md  flex justify-between items-center p-6'}>
                    <h4 className={'text-base font-medium text-[#222225]'}>Optimizer</h4>
                    <label className="switch">
                        <input type="checkbox"/>
                        <span className="slider"></span>
                        <span className="knob"></span>
                ...
                <div className={'bg-white rounded-md  flex justify-between items-center p-6'}>
                    <h4 className={'text-base font-medium text-[#222225]'}>NoHits</h4>
                    <label className="switch">
                        <input type="checkbox"/>
                        <span className="slider"></span>
                        <span className="knob"></span>
