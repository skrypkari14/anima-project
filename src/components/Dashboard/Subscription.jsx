...
const Subscription = () => {
    ...
    return (
        <div className={'p-6'}>
            ...
            <div className='mt-6 rounded-md bg-white py-6'>
                <div className='px-6 flex flex-col gap-6'>
                    <div>
                        <h4 className='text-2xl text-primary font-semibold'>Premium</h4>
                        <p className='mt-3 text-sm text-secundary'>Ваша подписка Deseption Premium активна</p>
                    </div>
                    <div>
                        <div className='flex items-center gap-2'>
                            <Calendar/> <p className='text-sm text-secundary'>Дата продления: 14 июня 2024</p>
                        </div>
                        <div className='mt-3 flex items-center gap-2'>
                            <Payment/> <p className='text-sm text-secundary'>Стоимость: 750 ₽ / мес</p>
                        </div>
                    </div>
                ...
                <div className='px-6 flex flex-col gap-2 md:flex-row items-center justify-between'>
                    <div className='flex flex-col md:flex-row gap-3 items-center'>
                        <Sparkle/>
                        <p className='text-secundary text-sm text-center'>Улучшите подписку до Business, доплатив 250 ₽</p>
                    </div>
                    <button
            ...
            <div className='mt-6 rounded-md bg-white p-6'>
                <h4 className='text-primary text-base font-semibold text-center md:text-left'>Лоадер</h4>
                <p className='text-sm text-secundary mt-1.5 text-center md:text-left'>Вы можете выбрать лоадер для любой из доступных версий</p>
